        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($pledge->isDistributed())
                        <div class="alert alert-info" style="background-color: #f3e8ff; border-color: #c4b5fd;">
                            ...
                            Your organization's donation has been distributed on {{ $pledge->distributed_at->format('M d, Y') }}!
                        </div>
                    @endif
                    ...
                    @if($pledge->families_helped || $pledge->relief_packages || $pledge->admin_feedback)
                        <div class="card bg-light border-0 mt-4">
                            <div class="card-body">
                                <h6><i class="bi bi-heart-fill text-danger me-2"></i>Your Organization's Impact</h6>
                ...
                <div class="card-footer">
                    <a href="{{ route('ngo.pledges.index') }}" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left me-2"></i>Back to Organization Pledges
                    </a>
                </div>
            </div>
        </div>
