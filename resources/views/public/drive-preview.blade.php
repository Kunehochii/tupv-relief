            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- Drive Photos Carousel --}}
                        @if ($drive->photos->count() > 0)
                            <div id="previewPhotoCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
                                <div class="carousel-indicators">
                                    @foreach ($drive->photos as $index => $photo)
                                        <button type="button" data-bs-target="#previewPhotoCarousel"
                                ...
                                @if ($drive->photos->count() > 1)
                                    <button class="carousel-control-prev" type="button" data-bs-target="#previewPhotoCarousel" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next" type="button" data-bs-target="#previewPhotoCarousel" data-bs-slide="next">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">Target: {{ number_format($drive->target_amount) }} items</small>
                        </div>
