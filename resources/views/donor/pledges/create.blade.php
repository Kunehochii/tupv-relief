...
@section('content')
    <div class="pledge-container">
        ...
        <form method="POST" action="{{ route(auth()->user()->role . '.pledges.store') }}" id="pledgeForm" novalidate>
            @csrf
                    ...
                    <div class="pledge-grid">
                        ...
                        <div class="drive-info-section">
                            ...
                            <div class="info-alert mt-4">
                                ...
                                After submitting, you'll receive a reference number. Please coordinate with DSWD for
                            ...
                            <div class="submit-section">
                                <div class="d-flex gap-3 flex-column flex-md-row">
                                    ...
                                    <a href="{{ route(auth()->user()->role . '.dashboard') }}" class="btn-cancel">
                                        Cancel
                                    </a>
                                </div>
                            </div>
...
@section('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Also allow pressing Enter on the group qty field to apply
