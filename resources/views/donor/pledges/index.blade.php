                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        @forelse($pledges as $pledge)
                            <tr>
                                <td>
                                    <a href="{{ route(auth()->user()->role . '.pledges.show', $pledge) }}" class="fw-medium">
                                ...
                                <td>
                                    <a href="{{ route(auth()->user()->role . '.pledges.show', $pledge) }}" class="btn btn-sm btn-outline-primary">
                                        View
                                    </a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-4 text-muted">
                                    ...
                                    <p class="mb-0">No pledges yet. <a href="{{ route(auth()->user()->role . '.pledges.create') }}">Make your first pledge</a></p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
