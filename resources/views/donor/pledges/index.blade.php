...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4>My Pledges</h4>
            <a href="{{ route(auth()->user()->role . '.pledges.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle me-2"></i><span class="d-none d-sm-inline">New Pledge</span><span
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @forelse($pledges as $pledge)
                                <tr>
                                    <td>
                                        <a href="{{ route(auth()->user()->role . '.pledges.show', $pledge) }}"
                                            class="fw-medium">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-muted">
                                        ...
                                        <p class="mb-0">No pledges yet. <a
                                                href="{{ route(auth()->user()->role . '.pledges.create') }}">Make your
                                                first pledge</a></p>
                                    </td>
                                </tr>
                            @endforelse
        ...
        <div class="d-md-none">
            @forelse($pledges as $pledge)
                <a href="{{ route(auth()->user()->role . '.pledges.show', $pledge) }}" class="text-decoration-none">
                    <div class="card mb-2">
            ...
            @empty
                <div class="text-center py-5 text-muted">
                    ...
                    <a href="{{ route(auth()->user()->role . '.pledges.create') }}">Make your first pledge</a>
                </div>
            @endforelse
        </div>
